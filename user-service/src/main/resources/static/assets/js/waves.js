...
// 弹出用户提示
function showCustombox(message,reflash){
    ...
    pubSub.on(message, function(evt,prop_name,new_val){
        jQuery("[data-" + data_attr + "=" + prop_name + "]").each(function(){
            ...
            if($bound.is("input,textarea")) {
                ...
                $bound.val(new_val);
                $bound.selectpicker();
                $bound.selectpicker('val',new_val);
            }
            else{
                $bound.html(new_val);
            }
...
function DataBinderBuilder(uid){
...
;(function(window) {
     ...
     * where the service doesn't want a delegated click handler.
     */
